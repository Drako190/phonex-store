...
const productos = [
  { 
    ...
    precio_antes:32999,
    badge:'nuevo',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/iphone16pro.png',  // ← aquí
  ...
  { 
    ...
    precio:27999,
    badge:'destacado',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/Samsunggalaxy.png',   // ← aquí
  ...
  { 
    ...
    precio_antes:24999,
    badge:'oferta',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/Googlepixel.png',       // ← aquí
  ...
  { 
    ...
    precio_antes:6499,
    badge:'oferta',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/AirPodspro.png', // ← aquí
  ...
  { 
    ...
    precio:24999,
    badge:'nuevo',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/iPadpro.png',  // ← aquí
  ...
  { 
    ...
    precio_antes:9999,
    badge:'oferta',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/Applewatch.png', // ← aquí
  ...
  { 
    ...
    precio_antes:799,
    badge:'oferta',
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/Cargadorusb.png',  // ← aquí
  ...
  { 
    ...
    categoria:'funda', 
    precio:999,
    imagen_principal: 'https://phonex-store.vercel.app/images/productos/Fundasiliconapro.png',  // ← aquí
